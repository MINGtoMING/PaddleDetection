...
class OVRTDETR(BaseArch):
    ...
    def __init__(self,
                 backbone="ResNet",
                 text_encoder="CLIPTextModelFromPretrained",
    ...
    def from_config(cls, cfg, *args, **kwargs):
        ...
        # text encoder
        text_encoder = create(cfg["text_encoder"])
        # neck
    ...
    def _forward(self):
        ...
        # Text Encoder
        text_feats = self.text_encoder(self.inputs)
        ...
        text_token_mask = self.inputs.get("text_token_mask", None).any(-1)
        out_transformer = self.transformer(body_feats, text_feats, pad_mask,
